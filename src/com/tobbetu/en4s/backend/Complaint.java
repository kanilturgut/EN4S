...
public class Complaint implements Serializable {
	...
	public void comment(String text) throws IOException,
		...
		try {
			...
			/*
			 * Olay su Mustafa, hic yorumu olmayan bir sikayet icin detay
			 * sayfasindan ilk yorumu siz ekleyin butonuna basina bir dialog
			 * cikiyor ve kullanici yorumu oradan giriyor. Gonder tusuna basinca
			 * comment kaydediliyor ama yukaridaki comments.add metodunda
			 * patliyor. Sen sorunu bulana kadar bu sekilde handle edelim burayi
			 */
			Log.e("Mustafa' ya adanmistir", "Girme buraya girme");
		}
	}
